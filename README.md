...
### História
 A linguagem Dart é uma linguagem multi-paradigma, Lançamento Inicial 2011, O Dart foi anunciado pela primeira vez pela Google em outubro de 2011. Ele foi projetado como uma linguagem de programação para desenvolvimento web e, especificamente, para melhorar o desenvolvimento de aplicativos web de grande escala. O Dart foi criado com o objetivo de ser uma alternativa mais eficiente e produtiva ao JavaScript, que era a principal linguagem de programação para desenvolvimento web na época. A Google viu a necessidade de uma linguagem que pudesse oferecer um desempenho melhor, ferramentas de desenvolvimento avançadas e suporte para desenvolvimento de aplicativos web complexos.
 Embora a Google tenha lançado o Dart com grandes esperanças, a adoção inicial foi limitada, principalmente devido à prevalência do JavaScript. No entanto, o Dart continuou a ser desenvolvido e aprimorado ao longo dos anos. Em agosto de 2018 o Dart, trouxe várias melhorias significativas à linguagem, incluindo um sistema de tipos mais forte (conhecido como "strong mode"), melhorias na performance e uma sintaxe mais limpa e moderna. Algum tempo depois ouve uma virada importante para o Dart aconteceu com o lançamento do framework de desenvolvimento de aplicativos móveis chamado Flutter, também desenvolvido pela Google. O Flutter utiliza o Dart como sua linguagem de programação principal e ganhou popularidade rapidamente para o desenvolvimento de aplicativos móveis multiplataforma, à  medida que o Flutter cresceu em popularidade, a comunidade de desenvolvedores do Dart também cresceu, resultando em um ecossistema mais ativo e recursos adicionais sendo desenvolvidos para a linguagem.
